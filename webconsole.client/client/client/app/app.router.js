System.register(['@angular/router', './components/framework.component', './components/bundles/bundles.component', './components/bundles/bundle.component', './components/logs.component', './components/services/services.component', './components/services/service.component', './components/packages.component', './components/help.component', './components/snapshots/snapshots.component', './components/runtime.component', './components/bundles/bundlecontent.component', './components/codemirror.component', './components/config.component'], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var router_1, framework_component_1, bundles_component_1, bundle_component_1, logs_component_1, services_component_1, service_component_1, packages_component_1, help_component_1, snapshots_component_1, runtime_component_1, bundlecontent_component_1, codemirror_component_1, config_component_1;
