System.register(['@angular/core', '@angular/common', "@angular/router-deprecated", '../services/backend.service', '../pipes/maxLength.pipe'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, common_1, router_deprecated_1, backend_service_1, maxLength_pipe_1;
    var LogsComponent;
    return {
        setters:[
            function (core_1_1) {
