System.register(['@angular/core', '@angular/common', "@angular/router", '../../services/backend.service', '../../services/breadcrumbs.service', '../../services/appglobals.service', '../../components/navbar/breadcrumb', '../../components/tabs', '../../components/tab', '../../pipes/bundleState.pipe', '../../pipes/bundlesFilter.pipe', '../../directives/percentBar.d3.directive', '../../directives/adjacency.directive', '../../directives/d3pkgdep.directive'], function(exports_1, context_1) {
    ...
    var core_1, common_1, router_1, backend_service_1, breadcrumbs_service_1, appglobals_service_1, breadcrumb_1, tabs_1, tab_1, bundleState_pipe_1, bundlesFilter_pipe_1, percentBar_d3_directive_1, adjacency_directive_1, d3pkgdep_directive_1;
        ...
        execute: function() {
            BundlesComponent = (function () {
                ...
                BundlesComponent = __decorate([
                    core_1.Component({
                        selector: 'bundles',
                        directives: [common_1.FORM_DIRECTIVES, router_1.ROUTER_DIRECTIVES, common_1.NgFor, common_1.NgFormModel, tabs_1.Tabs, tab_1.Tab, adjacency_directive_1.AdjacencyDirective, d3pkgdep_directive_1.D3PkgDepDirective, percentBar_d3_directive_1.PercentBarDirective],
