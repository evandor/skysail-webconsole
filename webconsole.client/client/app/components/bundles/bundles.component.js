System.register(['angular2/core', 'angular2/common', "angular2/router", '../../services/backend.service', '../../services/breadcrumbs.service', '../../components/navbar/breadcrumb', '../../pipes/bundleState.pipe', '../../pipes/bundlesFilter.pipe', '../../directives/percentBar.d3.directive'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, common_1, router_1, backend_service_1, breadcrumbs_service_1, breadcrumb_1, bundleState_pipe_1, bundlesFilter_pipe_1, percentBar_d3_directive_1;
        ...
        execute: function() {
            BundlesComponent = (function () {
                ...
                BundlesComponent = __decorate([
                    core_1.Component({
                        selector: 'bundles',
                        directives: [common_1.FORM_DIRECTIVES, router_1.ROUTER_DIRECTIVES, common_1.NgFor, common_1.NgFormModel, percentBar_d3_directive_1.PercentBarDirective],
