// Generated from C:\git\skysail-webconsole\webconsole.antlr\src\main\antlr4\io\skysail\webconsole\antlr\ImportPackage.g4 by ANTLR 4.5.3
...
public class ImportPackageParser extends Parser {
	...
	public static final int
		RULE_parameter = 0, RULE_importPackage = 1, RULE_importExpr = 2, RULE_packageNames = 3, 
		RULE_packageName = 4;
	public static final String[] ruleNames = {
		"parameter", "importPackage", "importExpr", "packageNames", "packageName"
	};
	...
	public ImportPackageParser(TokenStream input) {
		super(input);
		_interp = new ParserATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}
	public static class ParameterContext extends ParserRuleContext {
		public TerminalNode Directive() { return getToken(ImportPackageParser.Directive, 0); }
		public TerminalNode Attribute() { return getToken(ImportPackageParser.Attribute, 0); }
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ImportPackageListener ) ((ImportPackageListener)listener).enterParameter(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ImportPackageListener ) ((ImportPackageListener)listener).exitParameter(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ImportPackageVisitor ) return ((ImportPackageVisitor<? extends T>)visitor).visitParameter(this);
	...
	public static class ImportPackageContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ImportPackageListener ) ((ImportPackageListener)listener).enterImportPackage(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ImportPackageListener ) ((ImportPackageListener)listener).exitImportPackage(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ImportPackageVisitor ) return ((ImportPackageVisitor<? extends T>)visitor).visitImportPackage(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ImportExprContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ImportPackageListener ) ((ImportPackageListener)listener).enterImportExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ImportPackageListener ) ((ImportPackageListener)listener).exitImportExpr(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ImportPackageVisitor ) return ((ImportPackageVisitor<? extends T>)visitor).visitImportExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class PackageNamesContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ImportPackageListener ) ((ImportPackageListener)listener).enterPackageNames(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ImportPackageListener ) ((ImportPackageListener)listener).exitPackageNames(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ImportPackageVisitor ) return ((ImportPackageVisitor<? extends T>)visitor).visitPackageNames(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class PackageNameContext extends ParserRuleContext {
		public TerminalNode UniqueName() { return getToken(ImportPackageParser.UniqueName, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ImportPackageListener ) ((ImportPackageListener)listener).enterPackageName(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ImportPackageListener ) ((ImportPackageListener)listener).exitPackageName(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ImportPackageVisitor ) return ((ImportPackageVisitor<? extends T>)visitor).visitPackageName(this);
			else return visitor.visitChildren(this);
		}
	}
